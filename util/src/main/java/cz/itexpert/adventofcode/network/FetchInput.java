...
public class FetchInput {
  ...
  private void retrieveDay(int day, int year, String outputFolder) {
    retrieveInput(day, year, outputFolder);
  }
  ...
  public void retrieveInput(int day, int year, String outputFolder) {
    File dayFile = new File(outputFolder + "/day.txt");
    if (!dayFile.exists()) {
